...
contract('Clovers', async function(accounts) {
  ...
  describe('SimpleCloversMarket.sol', function() {
    ...
    it('should buy the clover by minting ClubToken before', async () => {
      ...
      console.log('amountToSpend', amountToSpend.toString())
      ...
      console.log('resultOfSpend', resultOfSpend.toString(10))

      let cloversControllerAddress = await simpleCloversMarket.cloversController()
      console.log({cloversControllerAddress})
      console.log(cloversController.address)
      ...
      let clubTokenControllerPaused = await clubTokenController.paused()
      console.log({clubTokenControllerPaused})
      let cloversControllerPaused = await cloversController.paused()
      console.log({cloversControllerPaused})

      tx = await clubTokenController.buy(_buyer, {value: amountToSpend.toString(10)})
      ...
      try {
        ...
        console.log('4',  from.toString(),  owner.toString(),  from.toString() === owner.toString())
        console.log('44')
